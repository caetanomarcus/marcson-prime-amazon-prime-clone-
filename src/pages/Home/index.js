...
export default class Home extends React.Component {
    ...
    getShows = async () => {
        ...
        const page2 = await  axios.get('https://api.themoviedb.org/3/trending/all/day?api_key=5f806e98f1b3ee6e498219d17b4720cc&language=pt-BR&page=2')
    ...
    render (){
        return(
           <Cards title='Os mais assistidos' shows={this.state.trendings}>
