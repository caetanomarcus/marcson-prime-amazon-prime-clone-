...
export default class Filmes extends React.Component {
    ...
    getShows = async () => {
        const page1 = await MoviesApi.get()
        const page2 = await  axios.get('https://api.themoviedb.org/3/movie/popular?api_key=5f806e98f1b3ee6e498219d17b4720cc&language=pt-BR&page=2')
    ...
    render (){
        return(
            <Cards title='Os melhores filmes' shows={this.state.trendings} > /
